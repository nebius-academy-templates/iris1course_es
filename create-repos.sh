...
for str in "${strings[@]}"; do
    curl -L \
        ...
        https://api.github.com/orgs/nebius-academy-templates/repos \
        -d '{"name":"'$str'","private":true,"is_template":true,"visibility":"private","description":"Nebius Academy project template"}'
done